...
function Feedback() {
    return (
        <div className='pt-[124px] pb-20 bg-[#FAFAFA]'>
            ...
            >
                <SwiperSlide>
                    <div className="flex flex-col gap-[20px] h-[230px] rounded-[10px] border-2 border-[#F53838] bg-[#FFF]">
                        <div className='p-[30px]'>
                            ...
                            <div className='mt-[10px]'>
                                <h2 className='text-[#0B132A] text-[16px] font-normal leading-[30px]'>“Wow... I am very happy to use this VPN, it turned out to be more than my expectations and so far there have been no problems. LaslesVPN always the best”.</h2>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="flex flex-col gap-[20px] h-[230px] rounded-[10px] border-2 border-[#DDD] bg-[#FFF]">
                        <div className='px-[30px] pt-[30px] pb-[42px]'>
                            ...
                            <div className='mt-[10px]'>
                                <h2 className='text-[#0B132A] text-[16px] font-normal leading-[30px]'>“I like it because I like to travel far and still can connect with high speed.”.</h2>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="flex flex-col gap-[20px] h-[230px] rounded-[10px] border-2 border-[#DDD] bg-[#FFF]">
                        <div className='px-[30px] pt-[30px] pb-[47px]'>
                            ...
                            <div className='mt-[10px]'>
                                <h2 className='text-[#0B132A] text-[16px] font-normal leading-[30px]'>“This is very unusual for my business that currently requires a virtual private network that has high security.”.</h2>
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="flex flex-col gap-[20px] max-h-[230px] rounded-[10px] border-2 border-[#F53838] bg-[#FFF]">
                        <div className='p-[30px]'>
                            <div className='flex items-center justify-between'>
                                <div className='flex gap-[20px]'>
                                    <img src='avatar-1.png' />
