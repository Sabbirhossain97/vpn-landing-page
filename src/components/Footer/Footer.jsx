...
function Footer() {
    return (
        <div className='bg-[#f5f5f5e5] relative pt-[200px]'>
            <div className='absolute z-5 bg-[#FFF] rounded-[10px] max-w-[1300px] mx-auto -top-[120px] left-0 right-0 flex justify-between'>
                <div className='flex justify-between items-center px-[70px] py-[58.5px] w-full'>
                    <div className='flex flex-col'>
                        <div className='text-[#0B132A] text-[35px] font-semibold leading-[45px]'>Subscribe Now for <br /> Get Special Features!</div>
                        <div className='mt-[20px] text-[#4F5665] text-[16px] font-normal leading-[30px]'>Let's subscribe with us and find the fun.</div>
                    </div>
            ...
            <div className='max-w-[1300px] flex justify-between mx-auto pb-[100px]'>
                <div className='flex flex-col'>
